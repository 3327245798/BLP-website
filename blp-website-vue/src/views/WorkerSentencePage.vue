  ...
  <a-layout id="components-layout-demo-custom-trigger">
    ...
    <a-layout>
      ...
      <a-breadcrumb style="margin:16px">
          ...
          <a-breadcrumb-item>创建句型</a-breadcrumb-item>
    ...
    <a-collapse v-model="activeKey">
      <a-collapse-panel  :header="item.createTime" v-for="(item,key,index) in sentenceData" :key="index">
        <p>
           <a-descriptions title="句型信息">
    <a-descriptions-item label="句型序列化表示">
      {{item.serialization}}
    </a-descriptions-item>
    <a-descriptions-item label="句型描述">
     {{item.description}}
    </a-descriptions-item>
    <a-descriptions-item label="句型例子">
     {{item.example}}
    </a-descriptions-item>
