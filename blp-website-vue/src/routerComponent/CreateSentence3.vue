...
<!-- 2022年12月11日 -->
  <div class="total">
    <p style="color:black;font-weight:bold">您是句型开发者，请对用户提交的句型进行开发</p>
     <a-table 
    ...
    <span slot="action" slot-scope="text, record">
      ...
      <a-button type="primary" size="small" ghost @click="showModal(record)">开发句型</a-button>
    ...
    <a-form-item label="来自于用户的句型" >
      ...
      <a-row :gutter="24">
        ...
        <a-col :span="12">
          <a-form-item label="部件" has-feedback>
            <a-select
              v-model="sentenceForm.unitAction"
              placeholder="请选择部件"
      ...
      <a-form-item label="参数">
        <span v-for="(param, index) in paramArr" :key="index" id="components-badge-demo-dot">
         ...
         <a-badge dot v-if="param.required==1"> </a-badge>
          ...
          >
          <!-- <a-tag v-else color="purple">无需参数
      ...
      <a-form-item label="开发句型">
       <!--  <a-textarea
          ...
          placeholder="你可以使用参数生产句型"
          :auto-size="{ minRows: 2, maxRows: 2 }"
         
        /> --> <!-- value="record.sentenceFromUserContent" -->
